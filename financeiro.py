...
# Essa é a sua lista que você me mandou. 

# O código tenta carregar do arquivo, se não existir, usa a sua lista oficial.
...
def total_faturado():
    ...
    # Soma o campo 'historico' de todos os registros
...
# FUNÇÃO REQUISITADA QUE ESTAVA FALTANDO
...
def listar_clientes():
    ...
    for c in clientes[-20:]:  # Mostra os últimos 20 para não estourar o limite do Telegram
...
# Inicializa carregando os dados existentes
